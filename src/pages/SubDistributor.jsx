    ...
    <div className="mx-auto max-w-5xl px-3 py-6 sm:px-6 sm:py-12">
      <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-6 items-start">
        <div className="glass rounded-3xl p-5 sm:p-8">
          ...
          {cryptoOrder && (
            <div className="mt-6 space-y-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5">
              ...
              <div className="rounded-xl border-2 border-amber-400/60 bg-amber-500/10 p-4">
                <p className="mb-2 text-xs font-semibold text-page-warning">{t('subDist.exactAmountLabel')}</p>
