    ...
    extend: {
      ...
      colors: {
        ...
        page: {
          ...
          surface: 'rgb(var(--page-surface-rgb) / calc(var(--page-surface-alpha) * <alpha-value>))',
          'surface-hover': 'rgb(var(--page-surface-hover-rgb) / calc(var(--page-surface-hover-alpha) * <alpha-value>))',
          divider: 'rgb(var(--page-divider-rgb) / calc(var(--page-divider-alpha) * <alpha-value>))',
          inset: 'rgb(var(--page-inset-rgb) / calc(var(--page-inset-alpha) * <alpha-value>))',
